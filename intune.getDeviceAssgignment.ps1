...
function Get-AuthToken {
    ...
    $clientId = "" #PowerShell Intune Graph app needs to be registered manually in Entra - see https://learn.microsoft.com/en-us/answers/questions/1659638/weve-detected-a-microsoft-intune-powershell-script
